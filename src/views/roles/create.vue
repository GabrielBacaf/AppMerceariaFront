...
const handleSave = async () => {
  isSubmitting.value = true;
    ...
    showAlert.success('Perfil/Role criado(a) com sucesso!');
...
<template>
  <div>
    ...
    <Card variant="create">
      <template #header>
        <h2 class="text-lg font-medium text-slate-800">Novo(a) Perfil/Role</h2>
      </template>
      ...
      <form @submit.prevent="handleSave" class="space-y-6">
        ...
        <div class="pt-4 flex justify-between gap-3 border-t border-slate-100">
          <Button type="button" class="bg-blue-50 text-blue-600 hover:bg-blue-100 border border-blue-200" @click="router.push('/roles')">
